...
function hang_hoa_select_page()
{
    ...
    if (!isset($_SESSION['page_count'])) {
        ...
        $_SESSION['page_count'] = ceil($row_count / 2);
    }
    echo $_SESSION['page_count'];
    if (exist_param("page_no")) {
        $_SESSION['page_no'] = $_REQUEST['page_no'] >= $_SESSION['page_count'] ? $_REQUEST['page_no'] - 1 : $_REQUEST['page_no'];
    }
    ...
    $sql = "SELECT * FROM hang_hoa ORDER BY ma_hh LIMIT " . $_SESSION['page_no']  . ", 2";
    return pdo_query($sql);
}
